 ...
 * <!-- end-user-doc -->
 * @see ch.raiffeisen.ipricer.definition.definitionDSL.DefinitionDSLPackage#getROLE()
 * @model
 * @generated
 */
...
{
  /**
   * The '<em><b>RADMIN</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RADMIN_VALUE
   * @generated
  ...
  /**
   * The '<em><b>RTRADER</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #RTRADER_VALUE
   * @generated
  ...
  /**
   * The '<em><b>RADMIN</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>RADMIN</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RADMIN
   * @model literal="radmin"
   * @generated
   * @ordered
   */
  public static final int RADMIN_VALUE = 0;
  ...
  /**
   * The '<em><b>RTRADER</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>RTRADER</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #RTRADER
   * @model literal="rtrader"
   * @generated
   * @ordered
   */
  public static final int RTRADER_VALUE = 2;
  ...
  public static ROLE get(int value)
  {
    switch (value)
    {
      case RADMIN_VALUE: return RADMIN;
      case NONE_VALUE: return NONE;
      case RTRADER_VALUE: return RTRADER;
